<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="dropdownlist1.aspx.cs" Inherits="samco.CBol..dropdownlist1" Async="true" %>
    ...
    <script type="text/javascript">
        function getCityList() {
            $.ajax({
                ...
                url: "dropdownlist1.aspx/PopulateDropDownList",
                data: "{}",
                dataType: "json",

                success: function (result) {
                    $('#DropDownList6').empty();
                    $('#DropDownList6').append("<option value='0'>--Select--</option>");
                    $.each(result.d, function (key, value) {
                        $("#DropDownList6").append($("<option></option>").val(value.LineName1).html(value.Value3));
                    });
                },
            ...
            <ContentTemplate>
                ...
                <div class="container">
                    ...
                    <div class="rowtimesheet11">
                        ...
                        <asp:DropDownList ID="DropDownList5" runat="server" CssClass="selectpicker" AutoPostBack="true"  data-live-search="true" Style="background-color: #eeeeee;" OnSelectedIndexChanged="DropDownList5_SelectedIndexChanged1"></asp:DropDownList>
                    </div>
                </div>
