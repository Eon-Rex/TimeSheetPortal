<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="mytimesheets.aspx.cs" Inherits="samco.CBol.mytimesheets" Async="true" %>
            ...
            <div class="rowtimesheet50">
                <div class="rowtimesheet501">
                    ...
                    <div class="rowtimesheet112"> 
                        <asp:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtgettimesheet" TargetControlID="txtgettimesheet"></asp:CalendarExtender>        
                    <asp:TextBox ID="txtgettimesheet" CssClass="form-control" Style="background-color: #eeeeee" runat="server"></asp:TextBox>                       
                    </div>
                </div>
                <div class="rowtimesheet502">
                    ...
                    <div class="rowtimesheet112">
                        ...
                        <asp:TextBox ID="txtTodate" CssClass="form-control" Style="background-color: #eeeeee" runat="server" ></asp:TextBox>                  
