<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="MyCalendar.aspx.cs" Inherits="samco.MyCalendar" Async="true" %>
            ...
            <div class="rowtimesheet50">
                <div class="rowtimesheet501">
                    ...
                    <div class="rowtimesheet112"> 
                        <asp:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtfromdate" TargetControlID="txtfromdate"></asp:CalendarExtender>        
                    <asp:TextBox ID="txtfromdate" CssClass="form-control" Style="background-color: #eeeeee" runat="server"></asp:TextBox>                       
                    </div>
                </div>
