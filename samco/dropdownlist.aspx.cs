    ...
    public partial class dropdownlist : System.Web.UI.Page
    {
        ...
        protected  async void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //ACX_DCCategoryList[] acxDcCategoryListArray = customeServiceClient.RetrieveProjCategoryIds(CallContext,"");// cd
                ...
                string RetrieveLinePropertyIds = "RetrieveProjCategoryIds";
        ...
        protected async void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string jsonstring3 = (string)await D365Call.PostD365Service(RetrieveProjDetail, postdata);
            ACX_DCProjDetail[] acxDcProjDetailArray = JsonConvert.DeserializeObject<ACX_DCProjDetail[]>(jsonstring3);
            ...
            var npgcode = new { _NPGCode =  _NPGCode };
            string RetrieveNPGSectionCodeIds = "RetrieveNPGSectionCodeIds";
            string jsonstring4 = (string)await D365Call.PostD365Service(RetrieveNPGSectionCodeIds, npgcode);
            ACX_DCNPGSectionCodeList[] dcnpgSectionCodeListArray = JsonConvert.DeserializeObject<ACX_DCNPGSectionCodeList[]>(jsonstring4);
        ...
        protected async void DropDownList5_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string RetrieveNPGSectionCodeIds = "RetrieveNPGSectionCodeIds";
            string jsonstring3 = (string)await D365Call.PostD365Service(RetrieveNPGSectionCodeIds, postdata);
            ACX_DCNPGSectionCodeList[] dcnpgSectionCodeListArray = JsonConvert.DeserializeObject<ACX_DCNPGSectionCodeList[]>(jsonstring3);
        ...
        [WebMethod]
        public async static Task<List<dropdownlist.Department>>PopulateDropDownList()
        {
            DataTable dataTable1 = new DataTable();
            List<dropdownlist.Department> departmentList = new List<dropdownlist.Department>();
            string str = "50001";
            MobileCustomeServiceClient customeServiceClient = new MobileCustomeServiceClient();
            customeServiceClient.ClientCredentials.Windows.ClientCredential.Domain = ConfigurationSettings.AppSettings["Domain"].ToString();
            customeServiceClient.ClientCredentials.Windows.ClientCredential.UserName = ConfigurationSettings.AppSettings["UserId"].ToString();
            ...
            var postdata = new  {_EmployeeId = _EmployeeId };

            string RetrieveNPGCodeIds = "RetrieveNPGCodeIds";
            samco.D365ServiceRefrence.D365ServiceCall callobj = new D365ServiceRefrence.D365ServiceCall();
            string jsonstring3 = (string)await callobj.PostD365Service(RetrieveNPGCodeIds, postdata);
            ...
            DataTable dataTable2 = new DataTable();
            dataTable2.Columns.Add("LineName1", typeof(string));
            dataTable2.Columns.Add("Value3", typeof(string));
            for (int index = 0; index < ((IEnumerable<ACX_DCNPGCodeList>)acxDcnpgCodeListArray).Count<ACX_DCNPGCodeList>(); ++index)
                dataTable2.Rows.Add((object)acxDcnpgCodeListArray[index].npgCode, (object)acxDcnpgCodeListArray[index].npgName);
            DataTable dataTable3 = dataTable2;
            if (dataTable3.Rows.Count > 0)
            {
                for (int index = 0; index < dataTable3.Rows.Count; ++index)
                    departmentList.Add(new dropdownlist.Department()
                    {
                        LineName1 = dataTable3.Rows[index]["LineName1"].ToString(),
                        Value3 = dataTable3.Rows[index]["Value3"].ToString()
                    });
            }
