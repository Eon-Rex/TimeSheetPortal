<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditTimesheet1.aspx.cs" Async="true" Inherits="samco.EditTimesheet1" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="rowtimesheet11">
                ...
                <%--<asp:TextBox ID="txtworkdate" CssClass="form-control" DataFormatString="{0:MM/dd/yyyy}" runat="server"></asp:TextBox>--%> 
        ...
        <div class="container">
            ...
            <div class="rowtimesheet11">
                <asp:TextBox ID="txttimekeeper" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="rowtimesheet11ddkhan" style="text-align: center;">
                ...
                <asp:DropDownList ID="DropDownList1" CssClass="selectpicker" data-live-search="true" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
        ...
        <div class="container">
            ...
            <div class="rowtimesheet11ddkhan">
                <asp:DropDownList ID="DropDownList3" CssClass="selectpicker" data-live-search="true" runat="server"></asp:DropDownList>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="rowtimesheet11ddkhan">
                <asp:DropDownList ID="DropDownList4" CssClass="selectpicker" data-live-search="true" runat="server" OnSelectedIndexChanged="DropDownList4_SelectedIndexChanged" AutoPostBack="true">
                    <asp:ListItem Text="--select--" Value="-1"></asp:ListItem>
                            <asp:ListItem Text="Chargable" Value="CH"></asp:ListItem>
                            <asp:ListItem Text="Non Billable" Value="NB"></asp:ListItem>
                            <asp:ListItem Text="Non Chargable" Value="NC"></asp:ListItem>
                </asp:DropDownList>
            </div>
        </div>
            ...
            <div class="rowtimesheet50">
                <div class="rowtimesheet501">
                    ...
                    <div class="rowtimesheet112">
                        <asp:DropDownList ID="txthours" CssClass="selectpicker" data-live-search="true" runat="server">
                ...
                <div class="rowtimesheet502">
                    ...
                    <div class="rowtimesheet112">                       
                        <asp:DropDownList ID="DropDownList2" CssClass="selectpicker" data-live-search="true" runat="server">
                            <asp:ListItem>Select</asp:ListItem>
                            <asp:ListItem>0</asp:ListItem>
                            <asp:ListItem>1</asp:ListItem>
                            <asp:ListItem>2</asp:ListItem>
        ...
        <div class="container">
           <%-- <div class="rowtimesheet1">
            ...
            <div class="rowtimesheet11">                
                <asp:DropDownList ID="DropDownList5" runat="server" Visible="false" AutoPostBack="true" CssClass="selectpicker" data-live-search="true" OnSelectedIndexChanged="DropDownList5_SelectedIndexChanged"></asp:DropDownList>
            </div>
        </div>
        <div class="container">
            <%-- <div class="rowtimesheet1">
            ...
            <div class="rowtimesheet11">                
                <asp:DropDownList ID="DropDownList6" Visible="false" CssClass="selectpicker" data-live-search="true" runat="server"></asp:DropDownList>
            </div>
        </div>
        <div class="container">
            <div class="rowtimesheet1">
            ...
            <div class="rowtimesheet11">
                <asp:TextBox CssClass="form-control" ID="txtdis" Style="background-color: #eeeeee" Height="70px" TextMode="MultiLine" runat="server"></asp:TextBox>
            </div>
        </div>        
        <div class="container">
            <div class="rowtimesheet11">
                <div class="rowtimesheet50">
                    ...
                    <div class="rowtimesheet502">
                        <a href="#">
                         <%-- <asp:ImageButton ID="imgsave" runat="server" ImageUrl="images/savebtn.jpg"  alt="save" border="0" OnClientClick="buttondisable()" OnClick="imgsave_Click" />--%>
                        
                                <asp:Button ID="savedate" runat="server" OnClientClick="this.disabled='true';"  UseSubmitBehavior="false" OnClick="savedate_Click"/>
                        </a>
                    </div>
                </div>
            </div>
